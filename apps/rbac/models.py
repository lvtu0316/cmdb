...
class UserProfile(AbstractUser):
    ...
    image = models.ImageField(upload_to="uploads/users/%Y-%m-%d", default="image/default.png",
                              max_length=100, null=True, blank=True)
    department = models.ForeignKey("Organization", null=True, on_delete=models.SET_NULL, verbose_name="部门" )
